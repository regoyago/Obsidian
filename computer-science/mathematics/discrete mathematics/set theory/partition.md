in [[set theory]], a partition of a [[set]] is a grouping of its elements into non-empty [[subset]]s, in such a way that every element is included in exactly one subset
