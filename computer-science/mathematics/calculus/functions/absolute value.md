the absolute value, or modulus of a [[real number]] $x$, denoted by $|x|$, is the [[mathematical function]] that gives the non-negative value of $x$ without regard to its sign  
