in mathematics, an injective function, also known as injection is a [[mathematical function]] that maps distinct elements to distinct elements, that is $f(x_1)=f(x_2)\implies x_1=x_2$
