in [[set theory]], for any set $S$ the inclusion [[binary relation]] $\subseteq$ is a [[partial order]] on the set $P(S)$ (the [[power set]] of  $S$- the set of all [[subset]]s of $S$) defined by $a\leq B \iff A\subsetew B$
